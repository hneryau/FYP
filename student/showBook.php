...
$sql18 = "SELECT * FROM HIGHLIGHT WHERE student_id = '$user_id' AND book_id = '$book_id'";
...
$sql24 = "SELECT * FROM NOTES WHERE student_id = '$user_id' AND book_id = '$book_id'";
...
?>
            ...
            function saveNotes() {
                ...
                $.post("saveNotes.php", {user_id: user_id, book_id: book_id, html: html, index: index});
            ...
            function saveHighlight2() {
                ...
                $.get("saveHighlight.php", {user_id: user_id, book_id: book_id, serializedHighlights: highlight, color: color});
            ...
            function resetPage() {
                ...
                if (confirm('Do you want to reset this page?')) {
                    ...
                    $.get("resetPage.php", {user_id: user_id, book_id: book_id});

...
echo '<a href="http://ebooksystem.cixx6.com/student/viewSubmission.php?submission_id=' . $submission_id . '">View Result</a><br>';
    ...
    while ($row = mysql_fetch_array($result1)) {
        ...
        if ($row[3] == 'MC') {
            ...
            if ($fanswer[0]->invertable == 0) {
                for ($i = 0; $i < count($fanswer[0]->answer); $i++) {
                    if ($row21[2] != $fanswer[0]->answer[$i]) {
                        if (strcasecmp($fanswer[0]->answer[$i], $row21[2]) == 0 && $fanswer[0]->cs == 0) {
                            $correctA = "YES";
            ...
            if ($fanswer[1]->invertable == 0) {
                for ($i = 0; $i < count($fanswer[1]->answer); $i++) {
                    if ($row21[3] != $fanswer[1]->answer[$i]) {
                        if (strcasecmp($fanswer[1]->answer[$i], $row21[3]) == 0 && $fanswer[1]->cs == 0) {
                            $correctB = "YES";
            ...
            if ($fanswer[2]->invertable == 0) {
                for ($i = 0; $i < count($fanswer[2]->answer); $i++) {
                    if ($row21[4] != $fanswer[2]->answer[$i]) {
                        if (strcasecmp($fanswer[2]->answer[$i], $row21[4]) == 0 && $fanswer[2]->cs == 0) {
                            $correctC = "YES";
            ...
            if ($fanswer[3]->invertable == 0) {
                for ($i = 0; $i < count($fanswer[3]->answer); $i++) {
                    if ($row21[5] != $fanswer[3]->answer[$i]) {

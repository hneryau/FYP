...
<html>
 ...
 <script>
    ...
    <body>
        ...
        $query_rs = "select book_id, bookName, category, coverPath, name from BOOK, AUTHOR where AUTHOR.author_id = BOOK.Author_id AND BOOK.category = 'History' AND status = '1'";

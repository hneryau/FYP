...
<?php
$sql18 = "SELECT * FROM HIGHLIGHT WHERE student_id = '$user_id' AND chapter_id = '$chapter_id'";
...
<?php
$sql24 = "SELECT * FROM NOTES WHERE student_id = '$user_id' AND chapter_id = '$chapter_id'";
...
?>
            ...
            function saveNotes() {
                ...
                var index = i;
                $.post("saveNotes.php", {user_id: user_id, chapter_id: chapter_id, html: html, index: index});
            }
            ...
            function saveHighlight2() {
                ...
                $.get("saveHighlight.php", {user_id: user_id, chapter_id: chapter_id, serializedHighlights: highlight, color: color});
            }
            ...
            function resetPage() {
                ...
                if (confirm('Do you want to reset this page?')) {
                    $.get("resetPage.php", {user_id: user_id, chapter_id: chapter_id});
                    setTimeout('reload()',1000);
                }
...
<body>
        <div id="total">
            ...
            <div id="book">
                <?php echo $_GET['serializedHighlights'] . $description ?>
            </div>
            <div id="book2">
                <?php echo $savedNotes ?>
            </div>

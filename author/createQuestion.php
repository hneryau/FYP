...
<script>
	...
	function addnewmc(){
		...
		.append('<tr><td align="center">Question Score:&nbsp;</td><td><input type="text" value ="0" name ="mark'+i+'"></td></tr>')

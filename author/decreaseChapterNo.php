<?php
	...
	// $sql = mysql_query("SELECT * FROM CHAPTER WHERE chapter_id = '$chapter_id'", $conn);
	...
	// echo "SID=".$section_id.", Temp=".$temp.", CID=".$chapter_id.", SNO=".$section_no.",Section NO +1:".($section_no+1).",section NO -1:".($section_no);
